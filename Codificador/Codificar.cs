...
namespace Codificador
{
    ...
    public class CodificadorTexto : CodificadorElemento
    {
        ...
        public byte[] Codificar(Elemento elemento)
        {
            ...
            if (elemento.descripcion.IndexOf('\n') != -1)
                throw new IOException("Descripcion no valida (contiene un salto de linea)"); cadenaCodificada = cadenaCodificada + elemento.descripcion + "\n";
    ...
    public class CodificadorBinario : CodificadorElemento
    {
        ...
        public byte[] Codificar(Elemento elemento)
        {
            ...
            new BinaryWriter(new BufferedStream(flujoMemoria));
